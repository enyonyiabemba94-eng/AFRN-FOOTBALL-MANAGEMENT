const CACHE_NAME = 'afrn-football-v9';
const APP_SHELL = [
  ...
  './supabase-config.js','./supabase-config-original.js','./afrn-transfer-workflow.js','./afrn-registration-workflow.js','./afrn-standings-workflow.js','./afrn-standings-ui.js','./afrn-realtime.js','./manifest.json','./css/style.css','./IMG-20260319-WA0093.jpg'
];
...
self.addEventListener('fetch',event=>{
 ...
 event.respondWith(fetch(event.request).then(async response=>{
  const inject={
   '/transfers.html':'afrn-transfer-workflow.js','/players.html':'afrn-registration-workflow.js','/matches.html':'afrn-standings-workflow.js','/competitions.html':'afrn-standings-ui.js'
  };
